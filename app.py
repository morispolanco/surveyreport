...
deparment_selection = st.multiselect('Department: ', department, default=department)

# --FILTER DATAFRAME BASED ON SELECTION


mask = (df['Age'].between(*age_selection)) & (df['Department'].isin(deparment_selection))
